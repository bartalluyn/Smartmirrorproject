...
Welcome to the Smart mirror project GitHub repository by Bart Alluyn.
This GitHub repository is a copy of Michael Teeuw's repository meant to make my own adjustments.

The readme below is written by Michael Teeuw and applies for the Magic Mirror code, as it does to my adjustments.
